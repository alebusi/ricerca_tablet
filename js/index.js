...
function generateVariables (){
	...
	lati = 4 ; // numro dei lati del poligono, se x < 3 verra diasegnato un cerchio, per una selezone random usare "getRandomInt(1, 8)"
	diametro_costruzione_poligono = 100; // grandezza poligono 
	diametro_costruzione_cerchio = 50; // grandezza cerchio centrale
	rotazione = Math.random() *Math.PI*2; // rotazione del poligono, "Math.PI/lati" serve per tenere le facce ortogonali alla finsetra, "Math.random() *Math.PI*2" per una rotazione random
