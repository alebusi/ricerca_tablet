...
function generateVariables (){
	...
	lati = getRandomInt(2, 6) ; // numro dei lati del poligono, se x < 3 verra diasegnato un cerchio, per una selezone random usare "getRandomInt(1, 8)"
...
function drawPoligon(targhet_canvas_id ,pos_x,pos_y , n_faces, outer_diameter, rotation, percent_pos,storePos, colour ) {
	...
	if (n_faces > 2){
		...
		canvas_context.lineWidth = 1; // spessore del filetto
		var i = 0
		while (i <= n_faces-1) {
